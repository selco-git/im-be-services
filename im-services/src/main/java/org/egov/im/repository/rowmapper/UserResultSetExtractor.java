...
import org.egov.im.domain.model.enums.*;
...
import static org.egov.im.domain.model.enums.AddressType.CORRESPONDENCE;
import static org.egov.im.domain.model.enums.AddressType.PERMANENT;
...
public class UserResultSetExtractor implements ResultSetExtractor<List<User>> {
            ...
            if (!usersMap.containsKey(userId)) {
                ...
                for (BloodGroup bloodGroup : BloodGroup.values()) {
                    if (bloodGroup.toString().equals(rs.getString("bloodgroup"))) {
                        user.setBloodGroup(bloodGroup.toString());
                    }
                }
    ...
    private Address populateAddress(ResultSet rs, User user) throws SQLException {
        ...
        Address address = Address.builder()
                ...
                .userId(rs.getString("addr_userid"))
