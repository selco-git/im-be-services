...
import org.egov.im.repository.rowmapper.AddressRowMapper;
...
public class AddressRepository {
     ...
     * @param tenantId
     */
    public void update(List<Address> domainAddresses, User user, String tenantId) {
        ...
        createNewAddresses(domainAddresses, entityAddresses, user.getId(), tenantId);
        updateAddresses(domainAddresses, entityAddresses, user);
    }
     ...
     * @param userId
     */
    private void updateAddresses(List<Address> domainAddresses, List<Address> entityAddresses, User userId) {
     ...
     * @param userId
     */
    private void updateAddress(Map<String, Address> typeToEntityAddressMap, Address address, User userId) {
