...
import org.egov.im.web.contract.UserRequest;
...
import org.egov.im.web.contract.auth.CustomUserDetails;
...
public class UserController {
    ...
    private UserSearchResponse searchUsers(@RequestBody UserSearchRequest request, HttpHeaders headers) {
        ...
        ResponseInfo responseInfo = ResponseInfo.builder().status(String.valueOf(HttpStatus.OK.value())).build();
        return new UserSearchResponse(responseInfo, userModels);
    }
